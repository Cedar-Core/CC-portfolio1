          ...
          {imageUrl ? (
            ...
            <div className="aspect-square bg-linear-to-br from-primary/20 to-secondary/20 rounded-2xl flex items-center justify-center relative overflow-hidden">
              ...
              <div className="absolute inset-0">
                ...
                <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-secondary/30 rounded-full blur-3xl" />
              </div>
              <div className="relative z-10 text-center">
                <div className="w-24 h-24 mx-auto mb-4 bg-linear-to-r from-primary to-secondary rounded-2xl flex items-center justify-center shadow-lg shadow-primary/25">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 pt-4">
            {values.map((value, index) => (
              <Shad.Card
                key={index}
                className="bg-surface/50 dark:bg-surface border-border/50 hover:border-primary/50 transition-colors"
              >
