        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center lg:text-left lg:max-w-3xl">
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl text-foreground font-bold leading-tight tracking-tight mb-8"
              style={{ fontFamily: "var(--font-oswald)" }}
            >
              <span className="block">Software that</span>
              <span className="block mt-2 text-primary">scales with you.</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg text-foreground-muted leading-relaxed font-light max-w-2xl mb-12 mx-auto lg:mx-0"
            >
              From concept to production. We design, architect, and build
              reliable software systems that grow with your business—not against
              it.
            </motion.p>
